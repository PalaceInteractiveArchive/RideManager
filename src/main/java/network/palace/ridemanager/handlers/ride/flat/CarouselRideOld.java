 ...
 */
public class CarouselRideOld extends Ride {
    ...
    public CarouselRideOld(String name, String displayName, double delay, Location exit, Location center, CurrencyType currencyType, int currencyAmount) {
